...
- Product-led consumer site uses a beautiful hero but lacks compare, buy/configure, price/plan, support, returns/refunds, or privacy/license paths: max 74.
...
- Product-led pages: product theater is paired with comparison, configuration, purchase/download, support, returns/refunds, and trust boundaries.
